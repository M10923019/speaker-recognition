...
def recordVoice(word,speakerName):
	...
	RATE = 44100
	RECORD_SECONDS = 4
	WAVE_OUTPUT_FILENAME = "speech\\Speaker_Recognition\\samples\\"+speakerName+"-2022\\"+speakerName+"_"+word+".wav"
...
def  train_model(speakerName):
	...
	training_file = open('speech\\Speaker_Recognition\\training_sample_list.txt','w')
	os.mkdir("speech\\Speaker_Recognition\\samples\\"+speakerName+"-2022")
	print("開始 錄音中-1")
	...
	source  = "speech\\Speaker_Recognition\\samples\\"   

	#path where training speakers will be saved
	dest = "speech\\Speaker_Recognition\\models\\"
	train_file = "speech\\Speaker_Recognition\\training_sample_list.txt"        
	...
	for path in file_paths:    
		...
		if count == 3:    
			gmm = mixture.GMM(n_components = 16, max_iter = 200, covariance_type='diag', n_init = 3)
			gmm.fit(features)
